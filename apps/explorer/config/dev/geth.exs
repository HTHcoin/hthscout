...
config :explorer,
  json_rpc_named_arguments: [
    ...
    transport_options: [
      ...
      url: System.get_env("ETHEREUM_JSONRPC_HTTP_URL") || "http://localhost:7118",
      ...
      method_to_url: [
        eth_call: ConfigHelper.eth_call_url("http://localhost:7118"),
        debug_traceTransaction: System.get_env("ETHEREUM_JSONRPC_TRACE_URL") || "http://localhost:7118"
      ],
